...
class Form1 extends React.Component
{
    ...
    return(
        ...
        <input type="radio" name="template" value={1} onClick={(e)=>{this.setState({templateid:e.target.value})}} />
        </div>
        <div className="second-selection">
        <input type="radio" name="template" value={2} onClick={(e)=>{this.setState({templateid:e.target.value})}} />
        </div>
        <div className="third-selection">
        <input type="radio" name="template" value={3} onClick={(e)=>{this.setState({templateid:e.target.value})}} />
        </div>
