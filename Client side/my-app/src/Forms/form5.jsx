              ...
              <div>
                {this.state.data.map((ele) => {
                  return (
                    <div>
                      <div className="row">
                        <input type="text"  value={this.state.skilltitle} required placeholder="SKILL" className="cont1" style={{ width: "60%" }} onChange={(e) => { this.setState({ skilltitle: e.target.value }) }} />
