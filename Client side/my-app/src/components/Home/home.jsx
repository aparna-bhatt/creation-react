...
function Home(){
    return(
      <>
      <Navbar />
      <div className="verticalStrip" style={{width:"30%"}}>
      
    </div>
        <div className="row topofpage">
        <div className="col verticalStrip">
          <h1 className="headline" style={{fontSize:"2rem"}}>Create Your Perfect Resume With CREATION</h1>
          <div className="wrapper">
            <div className="link_wrapper">
              <a className="fancy">Generate Resume </a>
              <div className="icon">
        ...
        <div className="col " style={{position: "relative"}}>
          ...
          <img className="img3" src="./template3.png" alt="" srcset="" />
        </div>
      </div>
